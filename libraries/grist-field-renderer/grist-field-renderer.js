...
import { renderText } from './renderers/render-text.js?v=1.0.8';
import { renderDate } from './renderers/render-date.js?v=1.0.8';
import { renderRef } from './renderers/render-ref.js?v=1.0.8';
import { renderChoice } from './renderers/render-choice.js?v=1.0.8';
import { renderRefList } from './renderers/render-reflist.js?v=1.0.8';
import { renderBool } from './renderers/render-bool.js?v=1.0.8';
import { renderColorPicker } from './renderers/render-color-picker.js?v=1.0.8';
import { renderProgressBar } from './renderers/render-progress-bar.js?v=1.0.8';
import { renderToggle } from './renderers/render-toggle.js?v=1.0.8';
import { renderIndicatorJson } from './renderers/render-indicator-json.js?v=1.0.8';
import { renderDynamicUI } from './renderers/render-dynamic-ui.js?v=1.0.8';
import { renderImage } from './renderers/render-image.js?v=1.0.8';
import { renderMoney } from './renderers/render-money.js?v=1.0.8';
...
(function () {
  ...
  link.id = 'grf-styles';
  link.rel = 'stylesheet';
  link.href = '../libraries/grist-field-renderer/styles/renderer-styles.css?v=1.0.8';
