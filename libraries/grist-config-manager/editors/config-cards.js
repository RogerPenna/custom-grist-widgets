export const CardConfigEditor = (() => {
    ...
    function readStylingTab(container) {
        ...
        if (borderModeInput) {
            ...
            s.cardBorderRadius = parseInt(tabEl.querySelector("#cs-st-card-border-radius").value, 10) ?? 8;
    ...
    function populateStylingTab(tabEl) {
        ...
        tabEl.querySelector("#cs-st-card-border-radius").value = s.cardBorderRadius !== undefined ? s.cardBorderRadius : 8;
