...
import '../libraries/grist-config-manager/editors/table-manifest.js?v=1.0.9';
...
import { TableRenderer } from '../libraries/grist-table-renderer/TableRenderer.js?v=1.0.9';
