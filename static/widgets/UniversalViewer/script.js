...
import { HeadlessTableLens } from '../libraries/headless-table-lens.js?v=1.3.32';
import { GristRestAdapter } from '../libraries/headless-rest-adapter.js?v=1.3.32';
...
import { GristFilterBar } from '../libraries/grist-filter-bar/grist-filter-bar.js?v=1.3.32';
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    async function initializeAndUpdate() {
        ...
        try {
            ...
            if (type === 'cardsystem') {
                const { CardSystem } = await import('../libraries/grist-card-system/CardSystem.js?v=1.3.32');
                ...
                const { TableRenderer } = await import('../libraries/grist-table-renderer/TableRenderer.js?v=1.3.32');
                ...
                const { BSCRenderer } = await import('../libraries/grist-bsc-renderer/BSCRenderer.js?v=1.3.32');
                ...
                const { IndicatorsRenderer } = await import('../libraries/grist-indicators-renderer/IndicatorsRenderer.js?v=1.3.32');
