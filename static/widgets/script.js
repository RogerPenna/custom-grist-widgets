...
import '../libraries/grist-config-manager/editors/table-manifest.js?v=1.3.32';
...
import { TableRenderer } from '../libraries/grist-table-renderer/TableRenderer.js?v=1.3.32';
