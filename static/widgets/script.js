...
import '../libraries/grist-config-manager/editors/table-manifest.js?v=1.0.8';
...
import { TableRenderer } from '../libraries/grist-table-renderer/TableRenderer.js?v=1.0.8';
