...
import '../libraries/grist-config-manager/editors/table-manifest.js?v=1.3.29';
...
import { TableRenderer } from '../libraries/grist-table-renderer/TableRenderer.js?v=1.3.29';
